...
class CacheService:
    ...
    async def get_cached_answers(self, question_id: str, model: str = "qwen3-32b") -> Optional[Dict[str, Any]]:
    ...
    async def cache_answers(self, answers: Dict[str, Any], question_id: str, model: str = "qwen3-32b", ttl: int = 7200):
