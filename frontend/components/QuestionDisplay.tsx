  ...
  return (
    <div className="space-y-4 mb-6">
      ...
      <div className="flex gap-2 sm:gap-3 items-start">
        <div className="rounded-full bg-orange-500 text-white w-7 h-7 sm:w-8 sm:h-8 flex items-center justify-center font-bold text-sm sm:text-base">
          U
        </div>
        <div className="bg-orange-50 border border-orange-200 p-2 sm:p-3 rounded-lg max-w-[85%] sm:max-w-[80%]">
          {question.thinking && (
            <p className="text-xs text-gray-500 italic mb-1 sm:mb-2 select-none">
              💭 {question.thinking}
            </p>
          )}
          <p className="whitespace-pre-wrap font-medium text-gray-900 select-none text-sm sm:text-base">
      ...
      {answer ? (
        <div className="flex gap-2 sm:gap-3 items-start ml-7 sm:ml-10">
          ...
          <div className="bg-blue-50 border border-blue-200 p-2 sm:p-3 rounded-lg max-w-[85%] sm:max-w-[80%]">
            <h4 className="font-bold mb-1 sm:mb-2 text-sm sm:text-base">Answer:</h4>
