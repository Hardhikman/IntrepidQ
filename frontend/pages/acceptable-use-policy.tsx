...
export default function AcceptableUsePolicyPage() {
  ...
  return (
    <>
      <Head>
        <title>Acceptable Use Policy - IntrepidQ AI</title>
        <meta name="description" content="Acceptable use policy for IntrepidQ AI service" />
        <link rel="canonical" href="https://intrepidq.xyz/acceptable-use-policy" />
        <script type="application/ld+json" dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Article",
            "headline": "Acceptable Use Policy - IntrepidQ AI",
            "description": "Acceptable use policy for IntrepidQ AI service",
            "author": {
              "@type": "Organization",
              "name": "IntrepidQ AI"
            },
