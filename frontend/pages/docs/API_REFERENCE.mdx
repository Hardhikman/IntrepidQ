...
- `news_source` (optional, default: "all"): News source for current affairs (leveraging DuckDuckGo Search)
...
## Answer Evaluation API(deprecated)
...
- User-selectable models for question generation