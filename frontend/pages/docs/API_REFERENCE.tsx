...
export async function getStaticProps() {
  ...
  const fullPath = join(docsDirectory, 'API_REFERENCE.md')
...
export default function API_REFERENCEDoc({ title, description, content, docId }: { title: string, description: string, content: string, docId: string }) {
