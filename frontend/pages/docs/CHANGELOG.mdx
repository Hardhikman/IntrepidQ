...
<Head>
  <link rel="canonical" href="https://intrepidq.xyz/docs/CHANGELOG" />
  <script type="application/ld+json" dangerouslySetInnerHTML={{
    __html: JSON.stringify({
      "@context": "https://schema.org",
      "@type": "TechArticle",
      "headline": "Changelog for IntrepidQ AI",
      "description": "Release history and changes for the IntrepidQ AI system",
      "author": {
        "@type": "Organization",
        "name": "IntrepidQ AI"
...
### Changed
- Replaced Tavily with DuckDuckGo Search (DDGS) for free news retrieval in Current Affairs mode.
- Implemented intelligent fallback from news headlines to general web search.
- Added exponential backoff retry logic for search reliability.
- Updated documentation and requirements to reflect news service transition.
...
- Keyword-Based Question Generation mode
- Current Affairs Mode
- Hybrid Technology Stack Migration (pgvector, Upstash Redis, Upstash Search)
- Model Provider Expansion (Google Gemini, OpenRouter)
...
- Frontend Architecture documentation to reflect current component structure
- Core Features documentation to reflect current generation modes

### Removed
- OCR (Optical Character Recognition) functionality from both frontend and backend
- Screenshot processing and evaluation features
- Answer Evaluator tab from the main interface
- Tabbed interface in the main question generation page (simplified to direct display)

## [1.0.0] - 2024-06-15

### Added
- Initial release of IntrepidQ AI
- Multi-Model Support (Groq models)
- Contextual Awareness with vector similarity search using Supabase pgvector
- Topic-Specific question generation for GS1-GS4 topics
- Whole Paper Mode for complete practice papers
- Google OAuth Integration for seamless authentication
- Daily Limits for authenticated users (5 questions/day) and guests (2/day)
- Real-time Statistics tracking
- User Dashboard with personalized analytics
- Model Performance Tracking
- Website Feedback System with floating feedback form
- Usage Analytics with comprehensive event tracking
- Modular Schema with organized PostgreSQL database
...
- Integration with DuckDuckGo Search (DDGS) for free, reliable current affairs content
- Intelligent fallback from headlines to general web search
...
12. `FRONTEND_ARCHITECTURE.md` - Updated to reflect current component structure and removed OCR functionality

### Removed Features Documentation
1. OCR (Optical Character Recognition) functionality has been completely removed from the system
2. Screenshot processing and evaluation features have been removed
3. Answer Evaluator tab has been removed from the main interface
4. Tabbed interface in the main question generation page has been simplified to direct display
