...
export async function getStaticProps() {
  ...
  const fullPath = join(docsDirectory, 'CHANGELOG.md')
...
export default function CHANGELOGDoc({ title, description, content, docId }: { title: string, description: string, content: string, docId: string }) {
