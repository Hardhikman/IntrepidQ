...
export async function getStaticProps() {
  ...
  const fullPath = join(docsDirectory, 'CONTRIBUTING.md')
...
export default function ContributingDoc({ title, description, content, docId }: { title: string, description: string, content: string, docId: string }) {
