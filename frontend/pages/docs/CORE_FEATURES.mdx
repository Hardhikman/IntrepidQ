...
### AI Model Support
The system uses the Qwen3 model for question generation:
- **Groq**: Primary provider for the Qwen3-32b model
...
- Integrates latest current affairs via DuckDuckGo Search (DDGS)
...
- Leverages DuckDuckGo Search (DDGS) for free, real-time news retrieval
- Supports targeting specific reliable sources (e.g., *Indian Express*, *The Hindu*)
- Built-in fallback system: News Headlines → General Web Search for 100% reliability
