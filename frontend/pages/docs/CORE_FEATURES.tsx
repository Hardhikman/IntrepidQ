...
export async function getStaticProps() {
  ...
  const fullPath = join(docsDirectory, 'CORE_FEATURES.md')
...
export default function CORE_FEATURESDoc({ title, description, content, docId }: { title: string, description: string, content: string, docId: string }) {
