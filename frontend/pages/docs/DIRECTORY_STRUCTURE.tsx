...
export async function getStaticProps() {
  ...
  const fullPath = join(docsDirectory, 'DIRECTORY_STRUCTURE.md')
...
export default function DIRECTORY_STRUCTUREDoc({ title, description, content, docId }: { title: string, description: string, content: string, docId: string }) {
