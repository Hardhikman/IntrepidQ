...
export async function getStaticProps() {
  ...
  const fullPath = join(docsDirectory, 'GETTING_STARTED.md')
...
export default function GettingStartedDoc({ title, description, content, docId }: { title: string, description: string, content: string, docId: string }) {
