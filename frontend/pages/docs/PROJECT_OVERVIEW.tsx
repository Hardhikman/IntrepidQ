...
export async function getStaticProps() {
  ...
  const fullPath = join(docsDirectory, 'PROJECT_OVERVIEW.md')
...
export default function ProjectOverviewDoc({ title, description, content, docId }: { title: string, description: string, content: string, docId: string }) {
