...
const template = (docId, title) => `import { promises as fs } from 'fs'
...
export async function getStaticProps() {
  ...
  const fullPath = join(docsDirectory, '${docId}.md')
...
export default function ${docId}Doc({ title, description, content, docId }: { title: string, description: string, content: string, docId: string }) {
